...
import { chatRefineSuggestions, saveRoadmap } from "@/lib/api";
              ...
              <div className="p-7 flex flex-col h-full">
                ...
                <div className="mt-auto pt-5 flex items-center justify-between" style={{ borderTop: "0.5px solid var(--border)" }}>
                  ...
                  <motion.button
                    ...
                    className="px-4 py-2 rounded-xl text-white text-xs font-semibold flex items-center gap-2"
                    style={{
                      background: "var(--accent)",
                      border: "none",
                      fontFamily: "var(--font-syne)",
                      cursor: choosingIndex !== null ? "not-allowed" : "pointer",
                      boxShadow: "var(--shadow-accent)",
                      opacity: choosingIndex !== null && choosingIndex !== i ? 0.5 : 1,
                    }}
                    whileHover={choosingIndex === null ? { scale: 1.03 } : {}}
                    whileTap={choosingIndex === null ? { scale: 0.97 } : {}}
                  >
                    {choosingIndex === i ? (
                      <>
                        <span
